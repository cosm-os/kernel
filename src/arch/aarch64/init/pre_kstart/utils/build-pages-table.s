    ...
    //
    //      1. Identity mapping for the kernel
    //         (VA == PA) to be able to switch on
    //         the MMU
    //      2. Mapping for the kernel with high VAs
    //         from KERNEL_OFFSET onwards
    //      3. Mapping for the kernel stack
    //      4. Mapping for the DTB Image
    //      5. Optional Mapping for a diagnostic
    //         UART
    //      ========================================
...
create_page_tables:
    ...
    //      registers are not to be modified for
    //      convenience:
...
zero_loop:
    ...
    //      ========================================
    //      Add a physmap entry
    //      x1: physical address, a multiple of
    //          GIGABYTE
...
build_physmap:
    ...
    //      ========================================
    //      Generic routine to build mappings.
    ...
    //      mapped using 2MB blocks.
    //
    //      This implies that the length is
    //      explicitly aligned to 2MB to prevent any
    //      translation aliases.
    //
    //      Since block translations at L2 cover 2MB
    //      blocks, that suits us nicely so
    //      everything uses 2MB L2 blocks.
    //
    //      Wasteful perhaps but at this stage it's
    //      convenient and in any case will get
    //      ripped out and reprogrammed in kstart.
    //      ========================================
build_map:
...
build_map_error:
    ...
    //      ========================================
    //      Statically allocated tables consumed by
    //      build_map.
    //      ========================================
    .align 12
identkmap_l0_ptable:
