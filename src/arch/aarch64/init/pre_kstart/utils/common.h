#ifndef __COSMOS_KERNEL_COMMON__
#define __COSMOS_KERNEL_COMMON__
...
#define SCTLR_M                 0x00000001                          // SCTLR_M bit used to control MMU ON and OFF
...
#endif /* __COSMOS_KERNEL_COMMON__ */
